...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <span
        className={`bg-white text-[#0D2D42] text-sm font-semibold px-4 py-2.5 rounded-2xl shadow-lg border border-[#E2EBF0] whitespace-nowrap transition-all duration-300 ${
      ...
      {/* Button circle */}
      <div
        className="wa-pulse w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_8px_32px_rgba(37,211,102,0.4)] hover:bg-[#20ba5a] transition-colors"
      >
